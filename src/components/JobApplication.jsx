...
export function JobApplication() {
    return (
        <section className="py-8 flex justify-center px-4 relative overflow-hidden">
            <motion.div
                initial={{ opacity: 0, y: 30 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8 }}
                className="bg-white max-w-lg w-full rounded-2xl shadow-xl overflow-hidden border border-gray-200 relative transform hover:scale-[1.01] transition-transform duration-500"
            >
                ...
                {/* Corpo: Os Requisitos */}
                <div className="p-8 relative z-10 bg-[#fdfbf7]">
                    <h3 className="font-bold text-navy-900 mb-6 uppercase text-xs tracking-widest border-b border-gray-200 pb-2">
                    ...
                    <ul className="space-y-4 mb-8">
                        {[
                            ...
                            <motion.li
                                ...
                                className="flex items-center gap-4 text-gray-700 bg-white p-4 rounded-lg border border-gray-100 shadow-sm"
                            >
                    ...
                    <div className="mt-8 pt-6 border-t border-gray-200 bg-gray-50 -mx-8 -mb-8 p-8">
                        ...
                        <div className="bg-white p-5 rounded-r-xl rounded-bl-xl shadow-sm text-sm text-gray-700 border-l-4 border-[#25D366] relative">
                            ...
                            <div className="flex items-center justify-end gap-2 text-xs text-navy-900 font-bold border-t border-gray-100 pt-2 mt-2">
